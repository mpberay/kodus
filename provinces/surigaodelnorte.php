...
$municipalities = getMunicipalities($conn, 'Surigao del Norte');
?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>KODUS | Surigao del Norte</title>
</head>
<body>
    ...
    <div class="content" id="content">
        <h1 class="thirdHead">Surigao del Norte</h1>
    ...
    <script>
        function exportToExcel() {
            window.location.href = 'export.php?province=Surigao del Norte';
        }
    </script>
