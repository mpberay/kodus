...
$municipalities = getMunicipalities($conn, 'Surigao del Sur');
?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>KODUS | Surigao del Sur</title>
</head>
<body>
    ...
    <div class="content" id="content">
        <h1 class="thirdHead">Surigao del Sur</h1>
    ...
    <script>
        function exportToExcel() {
            window.location.href = 'export.php?province=Surigao del Sur';
        }
    </script>
