...
$municipalities = getMunicipalities($conn, 'Agusan del Sur');
?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>KODUS | Agusan del Sur</title>
</head>
<body>
    ...
    <div class="content" id="content">
        <h1 class="thirdHead">Agusan del Sur</h1>
    ...
    <script>
        function exportToExcel() {
            window.location.href = 'export.php?province=Agusan del Sur';
        }
    </script>
