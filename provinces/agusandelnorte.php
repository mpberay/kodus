...
$municipalities = getMunicipalities($conn, 'Agusan del Norte');
?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>KODUS | Agusan del Norte</title>
</head>
<body>
    ...
    <div class="content" id="content">
        <h1 class="thirdHead">Agusan del Norte</h1>
    ...
    <script>
        function exportToExcel() {
            window.location.href = 'export.php?province=Agusan del Norte';
        }
    </script>
